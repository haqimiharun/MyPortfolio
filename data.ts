...
export const experience: Job[] = [
	...
	},
	{
		...
		description:
			"Contributed to the F-2401 project, focusing on database optimization and data integration. Assisted in the setup and configuration of the Synology server. Actively participated in progress update meetings and technical discussions. Developed practical skills in software development and server management.",
		skills: [
	...
	},
	{
		...
		description:
			"Developed strong interpersonal skills by providing exceptional customer service in a fast-paced environment. Contributed to team morale and cohesion by collaborating with colleagues to ensure smooth operations.",
	...
	},
	{
		...
		description:
			"Enhanced communication skills by effectively engaging with customers and addressing inquiries. Collaborated with team members to optimize store operations.",
...
export const projects: Project[] = [
	{
		...
		description:
			"Lead system development tasks including backend module updates, performance fixes, and data workflow improvements. Managed staging and production environments and automated deployments via GitLab CI/CD.",
	...
	},
	{
		...
		description:
			"Contributed to developing the F-2401 system by improving data integration workflows and interface usability. Key components built for data entry and reporting. Led efforts to fix bugs improving system efficiency by 20%.",
		techStack: [
			"System Development",
			"Data Integration",
			"Reporting",
	...
	},
	{
		...
		description:
			"Enhanced website SEO and social media engagement, contributing to a 15% increase in traffic. Streamlined system documentation processes improving team productivity by 15%.",
		techStack: [
			"SEO",
...
export const showcaseItems: ShowcaseItem[] = [
	{
		...
		description:
			"A centralized dashboard visualizing system health, CPU/Memory usage, and request latency. Configured using Prometheus as the data source to ensure real-time observability of production environments. Includes alerts for high-latency endpoints and server resource exhaustion.",
		images: [
	...
	},
	{
		...
		description:
			"Automated deployment pipeline showcasing Build, Test, and Deploy stages. This workflow ensures zero-downtime deployments and consistent code quality checks before merging. The pipeline includes separate jobs for unit testing, Docker image building, and deployment to staging/production servers.",
		images: [
	...
	},
	{
		...
		description:
			"Visualization of the containerized environment, isolating PHP application services, PostgreSQL databases, and NGINX web servers. The setup uses Docker Compose for local development and Kubernetes manifests for production orchestration, ensuring consistency across all environments.",
		images: [
