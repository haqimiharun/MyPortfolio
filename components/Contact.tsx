        ...
        <div className="bg-slate-950 border border-slate-800 p-8 rounded-2xl shadow-2xl max-w-2xl mx-auto">
           <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
              ...
              <a href={`mailto:${profile.email}`} className="flex flex-col items-center group">
                 ...
                 <p className="text-slate-500 text-sm group-hover:text-emerald-400 transition-colors">{profile.email}</p>
              </a>

              <div className="w-full h-px md:w-px md:h-16 bg-slate-800"></div>

              <a href={`https://${profile.linkedin}`} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center group">
                 ...
                 <p className="text-slate-500 text-sm group-hover:text-blue-400 transition-colors">Connect professionally</p>
              </a>
